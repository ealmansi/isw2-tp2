...
\begin{center}
  \begin{tabular}{| l | p{10cm} | }
    \hline
  \textbf{Descripción} & Los partidos se den en excelente calidad sin cortes, daod que la empresa proveedora se puede llegar a caer sin previo aviso.\\  \hline
...
\begin{center}
  \begin{tabular}{| l | p{10cm} | }
    \hline
  \textbf{Descripción} & Arquitectura distribuida en pequeños nodos.\\  \hline
  \textbf{Fuente} & UNA FUENTE\\  \hline
  \textbf{Estímulo} & UN ESTIMULO.\\  \hline
  \textbf{Entorno} & UN ENTORNO\\  \hline
  \textbf{Artefacto} & UN ARTEFACTO\\  \hline
